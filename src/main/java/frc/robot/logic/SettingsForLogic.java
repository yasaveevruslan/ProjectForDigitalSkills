...
/**
 * Класс отвечает за нужные настройки для логики,
 * то есть переработка значений из массивов в краткие команды для основных команд логики робота
 */
public class SettingsForLogic
{
    ...
    /**
     * Получение координат куба в складе и изменение его на пустое значение
     */
    ...
    /**
     * Создание кратких команд для логики по доске заказов
     */
